...
from networkArchitecture import NeuralNetwork
import unittest
from networkArchitecture import iterations, learning_rate, hidden_nodes, output_nodes
import sys
...
# Unit Tests to make sure our network is implemented right
